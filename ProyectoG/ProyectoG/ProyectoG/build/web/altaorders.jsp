...
<html>
    ...
    <body>
        ...
        <form class="form-horizontal" role="form" action="ControladorG" method="post">
            <input type="hidden" name="pagina" value="altaOrders">
          ...
          <img src="img/soporte1.png" width="73" height="69">
             ...
             <div class="form-group">
                ...
                <label class="control-label col-xs-2" for="orderDate" >Fecha Orden:</label>
                    <div class="col-xs-3">  
                        <input type="text" class="form-control" id="orderDate" placeholder="Ingrese Fecha Orden" name="orderDate">
                    </div>
            </div>
            ...
            <div class="form-group" >
                   <label class="control-label col-xs-2" for="requiredDate" >Fecha Requerida:</label>
                        <div class="col-xs-3">
                            <input type="text" class="form-control" id="requiredDate" placeholder="Ingrese Fecha Requerida" name="requiredDate">
                        </div>
                <label class="control-label col-xs-2" for="shippedDate" >Fecha Envio:</label>
                    <div class="col-xs-3">
                        <input type="text" class="form-control" id="shippedDate" placeholder="Ingrese Fecha Envio" name="shippedDate" >
                    </div>
            </div>
             ...
             <div class="form-group" >
                <label class="control-label col-xs-2"for="status" >Estatus:</label>
                    <div class="col-xs-3">  
                        <input type="text" class="form-control" id="status" placeholder="Ingrese status" name="status">
                    </div>
            </div>
            ...
            <div class="form-group" >
                <label class="control-label col-xs-2" for="comments" >Comentarios:</label>
                    <div class="col-xs-3">  
                        <input type="text" class="form-control" id="comments" placeholder="Ingrese Pais" name="comments">
                    </div>
            </div>
            ...
            <div class="form-group" >                
                <label  class="control-label col-xs-2" for="customerNumber" >Numero Cliente:</label>
                    <div class="col-xs-3">  
                        <input type="text" class="form-control" id="customerNumber" placeholder="Ingresa Codigo Postal" name="customerNumber">
                    </div> 
            </div>
            ...
            <div class="form-group">
                <div class="col-xs-offset-2 col-xs-3">
                    ...
                    <a href="Controlador?paginaOrder=consultaOrder" class="btn btn-default" role="button">Consulta</a>
                </div>
            </div>
        </form>
